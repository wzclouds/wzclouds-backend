...
@Slf4j
@MapperScan(
        basePackages = {"com.github.wzclouds.online"},
        annotationClass = Repository.class,
        sqlSessionFactoryRef = OnlineDatabaseAutoConfiguration.DATABASE_PREFIX + "SqlSessionFactory")
@EnableConfigurationProperties({MybatisPlusProperties.class, DatabaseProperties.class})
public class OnlineDatabaseAutoConfiguration extends BaseDatabaseConfiguration {
    /**
     * 每个数据源配置不同即可
     */
    final static String DATABASE_PREFIX = "biz";

    public OnlineDatabaseAutoConfiguration(MybatisPlusProperties properties,
