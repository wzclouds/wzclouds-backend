...
@Slf4j
@MapperScan(
        basePackages = {"com.github.wzclouds.uid"},
        annotationClass = Repository.class,
        sqlSessionFactoryRef = PublicDatabaseAutoConfiguration.DATABASE_PREFIX + "SqlSessionFactory")
@EnableConfigurationProperties({MybatisPlusProperties.class, DatabaseProperties.class})
public class PublicDatabaseAutoConfiguration extends BaseDatabaseConfiguration {
    /**
     * 每个数据源配置不同即可
     */
    final static String DATABASE_PREFIX = "master";

    public PublicDatabaseAutoConfiguration(MybatisPlusProperties properties,
