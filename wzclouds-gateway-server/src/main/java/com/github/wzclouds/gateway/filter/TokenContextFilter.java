package com.github.wzclouds.gateway.filter;

import cn.hutool.core.util.ObjectUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.core.util.URLUtil;
import com.github.wzclouds.base.R;
import com.github.wzclouds.common.constant.BizConstant;
import com.github.wzclouds.common.constant.CacheKey;
import com.github.wzclouds.common.properties.IgnoreTokenProperties;
...
import static com.github.wzclouds.context.BaseContextConstants.BASIC_HEADER_KEY;
import static com.github.wzclouds.context.BaseContextConstants.BEARER_HEADER_KEY;
import static com.github.wzclouds.context.BaseContextConstants.JWT_KEY_CLIENT_ID;
import static com.github.wzclouds.context.BaseContextConstants.JWT_KEY_TENANT;
import static com.github.wzclouds.exception.code.ExceptionCode.JWT_OFFLINE;
...
public class TokenContextFilter implements WebFilter, Ordered {
    ...
    @Value("${wzclouds.database.multiTenantType:SCHEMA}")
...
//    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
    ...
    private Mono<Void> parseToken(ServerWebExchange exchange, WebFilterChain chain) {
        ...
        if (isDev(token)) {
            authInfo = new AuthInfo().setAccount("wzclouds").setUserId(3L)
