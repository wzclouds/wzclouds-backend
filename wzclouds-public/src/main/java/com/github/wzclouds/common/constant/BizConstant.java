package com.github.wzclouds.common.constant;
...
public interface BizConstant {
     ...
     * 默认的定时任务组
     */
    String DEF_JOB_GROUP_NAME = "wzclouds-jobs-server";
    /**
     * 短信发送处理器
     */
     ...
     * 基础库
     */
    String BASE_DATABASE = "wzclouds_base";
    /**
     * 扩展库
     */
    String EXTEND_DATABASE = "wzclouds_extend";
